        ...
        <div class="ads-category-section">
          <div class="container">
            ...
            <div class="row">
              ...
              <div class="row" id="skeletonLoading">
...
$(document).ready(function () {
    ...
    window.addEventListener("scroll", (e) => {
      ...
      if (window.scrollY + e.target.children[0].clientHeight + 20 > loadingPoint.offsetTop && loadMore && !loading) {
          loading = true
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-4 col-4 filter-item">
                                <a href="{{ route('filter', ['chooseCategory' => $classification->id]) }}">
                                    <div class="item">
                                        <div class="content">
                                            <h4 class="name">${classification.name}</h4>
                                            <p class="total-ads">${classification.users.length}</p> <!-- Use 'length' to count users in an array -->
                                        </div>
                                        <div class="icon">
    ${classification.image
        ? `<img src="${baseUrl}/classification/${classification.image}" alt="${classification.name}-icon" />`
        : `<img src="${baseUrl}/frontend/assets/images/buisness_default.svg" alt="Default image" />`}
</div>
